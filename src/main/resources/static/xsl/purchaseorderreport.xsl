				...
				<fo:static-content flow-name="header-first">
					<fo:block-container height="18mm" width="18mm" right="0mm" position="absolute">
						<fo:block>
							...
							<fo:external-graphic padding="0" margin="0" space-start="0" space-end="0" pause-before="0" pause-after="0" content-height="18mm" content-width="18mm" scaling="non-uniform" src="url('resources/img/{$imagepath}')"/>
						</fo:block>
					</fo:block-container>
				...
				<fo:block font-size="8px" padding-top="30px" padding-bottom="5px" text-align="left">
					<fo:table table-layout="fixed" width="100%" border-collapse="collapse" >
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell><fo:block font-weight="bold">Total Amount</fo:block></fo:table-cell>
								<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
								<fo:table-cell><fo:block font-weight="bold"><xsl:value-of select="totalAmount"/></fo:block></fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell><fo:block>Supplier</fo:block></fo:table-cell>
								<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
								<fo:table-cell><fo:block><xsl:value-of select="supplier"/></fo:block></fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell><fo:block>Supplier Name</fo:block></fo:table-cell>
								<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
								<fo:table-cell><fo:block><xsl:value-of select="supplierName"/></fo:block></fo:table-cell>
							</fo:table-row>
							...
							<fo:table-row>
								<fo:table-cell><fo:block>Order Date</fo:block></fo:table-cell>
								<fo:table-cell><fo:block>:</fo:block></fo:table-cell>
