...
public class RM0701ServiceImpl extends AbstractReportService {
	...
	private List<FormFieldBuilder> generateFields() {
		...
		fieldsList.add(FormFieldBuilder.generateSearchField(3, "Member ID", "search/memberId", "", false));
		
		fieldsList.add(FormFieldBuilder.generateDropdownField(4, "Dag Type", group, "", false));
