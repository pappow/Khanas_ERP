...
public class ReportParamMap {
	...
	static {
		...
		RM0301.put("param4", "XCUS|" + ReportParamDataType.STRING.name());
		RM0301.put("param5", "XITEM|" + ReportParamDataType.STRING.name());
		RM0301.put("param6", "XSTATUSPOR|" + ReportParamDataType.STRING.name());
