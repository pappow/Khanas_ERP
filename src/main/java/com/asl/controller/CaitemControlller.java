...
import com.asl.enums.ItemCodeType;
...
public class CaitemControlller extends ASLAbstractController {
	...
	public String loadCaitemPage(Model model) {
		...
		model.addAttribute("xitemCategories", xcodeService.findByXtype(ItemCodeType.ITEM_CATEGORY.getCode()));
		model.addAttribute("xitemGroups", xcodeService.findByXtype(ItemCodeType.ITEM_GROUP.getCode()));
		model.addAttribute("xunitPurs", xcodeService.findByXtype(ItemCodeType.PURCHASE_UNIT.getCode()));
		model.addAttribute("xunitSels", xcodeService.findByXtype(ItemCodeType.SELLING_UNIT.getCode()));
